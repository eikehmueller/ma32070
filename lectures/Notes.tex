...
$$
\begin{lstlisting}
np.einsum("ii->",A)   # or: np.linalg.trace(A)
\end{lstlisting}
\end{description}
\end{frame}
...
\begin{itemize}
\item Exact solution $u\in \mathcal{V}$ solves $a(u,v)=b(v)\; \forall v\in\mathcal{V}$ 
...
$$
\begin{center}
\includegraphics[width=\linewidth]{figures/lagrange_nodes.pdf}
\end{center}
\textbf{Ordering of points}
\begin{minipage}{0.75\linewidth}
\begin{itemize}
  \item points associated with vertices $v_0$, $v_1$, $v_2$ (in this order); $\nu_{\text{vertex}}=1$
  \item points associated with facets $F_0$, $F_1$, $F_2$ (in this order); $\nu_{\text{facet}}=p-1$, ordered according to arrows
  \item points associated with the interior $K^0$ of the cell $\widehat{K}$; $\nu_{\text{interior}}=\frac{1}{2}(p-1)(p-2)$
\end{itemize}
\end{minipage}
\hfill
\begin{minipage}{0.2\linewidth}
  \begin{center}
  \includegraphics[width=2\linewidth]{figures/reference_triangle_small.pdf}
  \end{center}
\end{minipage}
\end{frame}
